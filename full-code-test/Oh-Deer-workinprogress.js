...
function draw() {
  print("corgi's y "+character.pos.y);
  print("")
...
//get stuck on stump
    ...
    if (keyIsDown(RIGHT_ARROW) &&this.x<=-70 &&this.x>=-350){
      this.x = this.x-this.speed;
      this.shift=this.shift/10;
    }
    ...
    if (keyIsDown(RIGHT_ARROW)&& 400>=character.pos.y){
      this.x = this.x-this.speed;
      this.shift=this.shift/10;
    }
   //  if (this.x >= 500 && this.pos.x <= 660) {
   //   ground = 180;
   // }

//get stuck on boulder
    // if (keyIsDown(RIGHT_ARROW)&&this.x+360>=10){
    //   this.x = this.x-this.speed;
    //   this.shift=this.shift/10;
    // }
    // if (keyIsDown(RIGHT_ARROW)&&200>=character.pos.y){
    //   this.x = this.x-this.speed;
    //   this.shift=this.shift/10;
    // }
